...
// ACF hero background image logic
...
<main id="submission-dates" class="tbics-page site-main" role="main">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-9">
          ...
          <section aria-labelledby="sec-types" class="mb-5">
            <h2 id="sec-types" class="h4 mb-3">Submission Paper Types</h2>
          ...
          <section aria-labelledby="sec-review" class="mb-5">
            <h2 id="sec-review" class="h4 mb-3">Review Process</h2>
          ...
          <section aria-labelledby="sec-formatting" class="mb-5">
            <h2 id="sec-formatting" class="h4 mb-3">Formatting &amp; Template</h2>
         ...
         <!-- 4) Submission System -->
            ...
            <h2 id="sec-submission" class="h4 mb-3">Submission System</h2>
          ...
          <section aria-labelledby="sec-publication" class="mb-5">
            <h2 id="sec-publication" class="h4 mb-3">Publication</h2>
            <p class="mb-0">
  ...
  <h2 id="sec-dates" class="h4 mb-3">Important Dates</h2>
