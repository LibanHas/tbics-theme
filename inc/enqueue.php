...
if ( ! function_exists( 'understrap_scripts' ) ) {
	...
	function understrap_scripts() {
		...
		// ✅ Add this to load your custom compiled SCSS output
		wp_enqueue_style(
			'tbics-custom-style',
		...
		// ✅ Add your custom JS for the mobile menu
		wp_enqueue_script(
			'tbics-custom-js',
			get_template_directory_uri() . '/js/custom.js',
			array('jquery'),
			filemtime( get_template_directory() . '/js/custom.js' ), // use filemtime for cache busting
			true
		);
